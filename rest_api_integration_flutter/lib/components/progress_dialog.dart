...
class ProgressDialog extends StatefulWidget {
  ...
  double borderRadius;
  String text;
  _ProgressDialogState progressDialogState;
  ...
  @override
  createState() => progressDialogState = new _ProgressDialogState(
...
class _ProgressDialogState extends State<ProgressDialog> {
      ...
      child: new Column(
        ...
        children: <Widget>[
          ...
          new Container(
            ...
            child: new Text(text, style: new TextStyle(color: color)),
          ),
        ],
      ),
    );
  ...
  Widget _getCircularProgress() {
    return new CircularProgressIndicator(valueColor: new AlwaysStoppedAnimation(color));
  }
}
